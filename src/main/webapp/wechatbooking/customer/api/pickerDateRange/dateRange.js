...
function pickerDateRange(inputId, options) {
    ...
    var wrapper = {
        ...
        ta: [
        	//解决竖屏日期选择框过宽问题，将宽度限制为300px
            '<div id="' + this.calendarId + '" class="ta_calendar ta_calendar2 cf" style="width:300px;">',
...
pickerDateRange.prototype.show = function(isCompare, __method) {
    ...
    $("#" + this.calendarId).css('top', pos.top + (__method.mOpts.theme == 'ta' ? 45 : 32) + 'px');
    //第一次显示的时候，一定要初始化输入框
